...
export const TIMES      = ["5 min", "15 min", "1 hr", "2 hrs", "4 hours", "Multi-day", "Year+"];

export const PRI_ORD  = { High: 0, Medium: 1, Low: 2, None: 3 };
export const TIME_ORD = { "5 min": 0, "15 min": 1, "1 hr": 2, "2 hrs": 3, "4 hours": 4, "Multi-day": 5, "Year+": 6 };
...
export const TIM_CLR = { "5 min": "#6dde9e", "15 min": "#a8e6a3", "1 hr": "#e8c547", "2 hrs": "#f5a55b", "4 hours": "#f5855b", "Multi-day": "#ff6b6b", "Year+": "#cc4444" };
